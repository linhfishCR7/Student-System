...
{
    public partial class A00_ChiTietUser : System.Web.UI.Page
    {
        ...
        protected void btnAddRecord_Click(object sender, EventArgs e)
        {
            if (IsValid)
            {
                ...
                parameters["MaKhoa"].DefaultValue = ddlMaKhoa.SelectedValue;
                parameters["RoleId"].DefaultValue = ddlRole.SelectedValue;
                try
                {
                    if (txtEmail.Text == "")
                    {
                    ...
                    else if (ddlMaKhoa.SelectedValue.ToString() == "")
                    {
                        ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Các trường (*) không được bỏ trống.');", true);
                    }
                    else if (ddlRole.SelectedValue.ToString() == "")
                    {
                        ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Các trường (*) không được bỏ trống.');", true);
                    }
                        ...
                        try
                        {
                                         ...
                                         new OleDbConnection(excelConnectionString))
                            {
                                ...
                                using (DbDataReader dr = command.ExecuteReader())
                                {
                                    ...
                                    {
                                        bulkCopy.DestinationTableName = "tbl00_ChiTietUser";
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("editRecord"))
            {
                ...
                txtEmail1.Text = HttpUtility.HtmlDecode(gvrow.Cells[3].Text).ToString();
                ddlMaKhoa1.SelectedValue = HttpUtility.HtmlDecode(gvrow.Cells[4].Text).ToString();
                ddlRole1.SelectedValue = HttpUtility.HtmlDecode(gvrow.Cells[5].Text).ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            parameters["MaKhoa"].DefaultValue = ddlMaKhoa1.SelectedValue;
            parameters["RoleId"].DefaultValue = ddlRole1.SelectedValue;
            try
            {
                if (txtMaSo1.Text == "")
                {
                ...
                else if (ddlMaKhoa1.SelectedValue.ToString() == "")
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Các trường (*) không được bỏ trống.');", true);
                }
                else if (ddlRole1.SelectedValue.ToString() == "")
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Các trường (*) không được bỏ trống.');", true);
                }
