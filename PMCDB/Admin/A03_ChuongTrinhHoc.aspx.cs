...
{
    public partial class A03_ChuongTrinhHoc : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("editRecord"))
            {
                ...
                txtMaCT1.Text = HttpUtility.HtmlDecode(gvrow.Cells[2].Text).ToString();
                txtTenCT1.Text = HttpUtility.HtmlDecode(gvrow.Cells[3].Text).ToString();
        ...
        private void executeDelete(string code)
        {
            if (IsValid)
            {
                ...
                parameters["MaCT"].DefaultValue = code;
