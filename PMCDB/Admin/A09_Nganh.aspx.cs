...
{
    public partial class A09_Nganh : System.Web.UI.Page
    {
        ...
        protected void btnAddRecord_Click(object sender, EventArgs e)
        {
            if (IsValid)
            {
                ...
                parameters["TenNganh"].DefaultValue = txtTenNganh.Text;
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("editRecord"))
            {
                ...
                txtMaNganh1.Text = HttpUtility.HtmlDecode(gvrow.Cells[2].Text).ToString();
                txtTenNganh1.Text = HttpUtility.HtmlDecode(gvrow.Cells[3].Text).ToString();
                txtMaKhoa1.Text = HttpUtility.HtmlDecode(gvrow.Cells[4].Text).ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (IsValid)
            {
                ...
                parameters["MaKhoa"].DefaultValue = txtMaNganh1.Text;
                parameters["TenKhoa"].DefaultValue = txtTenNganh1.Text;
                parameters["NamThanhLap"].DefaultValue = txtMaKhoa1.Text;
                try
                {
                    if (txtMaNganh1.Text == "")
                    {
        ...
        private void executeDelete(string code)
        {
            if (IsValid)
            {
                ...
                parameters["MaNganh"].DefaultValue = code;
