<%@ Page Title="" Language="C#" MasterPageFile="~/Sa.Master" AutoEventWireup="true" CodeBehind="A04_LopHoc.aspx.cs" Inherits="PMCDB.Admin.A04_LopHoc" %>
    ...
    <asp:Panel ID="panelPhanQuyen" runat="server">
                ...
                <asp:UpdatePanel ID="upCrudGrid" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" HorizontalAlign="Center" OnRowCommand="GridView1_RowCommand"
                            ...
                            DataKeyNames="MaLop" CssClass="table" DataSourceID="SqlDataSource1">
                            <Columns>
                                ...
                                <div class="modal-body">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>Mã Khoa: (*)</td>
                                            <td>
                                                <asp:TextBox ID="txtMaKhoa1" runat="server" CssClass="form-control"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Mã Khóa Học: (*)</td>
        ...
        <div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PMCDBConnectionString %>"
                ...
                InsertCommand="INSERT INTO [tbl04_LopHoc] ([MaLop], [MaKhoa], [MaKhoaHoc], [MaCT], [STT]) VALUES (@MaLop, @MaKhoa, @MaKhoaHoc, @MaCT, @STT)"
                SelectCommand="SELECT * FROM [tbl04_LopHoc]"
                UpdateCommand="UPDATE [tbl04_LopHoc] SET [MaKhoa] = @MaKhoa, [MaKhoaHoc] = @MaKhoaHoc, [MaCT] = @MaCT, [STT] = @STT WHERE [MaLop] = @MaLop">
                <DeleteParameters>
