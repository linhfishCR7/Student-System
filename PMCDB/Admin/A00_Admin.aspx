<%@ Page Title="" Language="C#" MasterPageFile="~/Sa.Master" AutoEventWireup="true" CodeBehind="A00_Admin.aspx.cs" Inherits="PMCDB.Admin.A00_Admin" %>
    ...
    <asp:Panel ID="panelPhanQuyen" runat="server">
                ...
                <asp:UpdatePanel ID="upCrudGrid" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" HorizontalAlign="Center" OnRowCommand="GridView1_RowCommand"
                            ...
                            DataKeyNames="EmailAdmin" CssClass="table" DataSourceID="SqlDataSource1">
                            <Columns>
                                ...
                                <asp:BoundField DataField="EmailAdmin" HeaderText="Email" ReadOnly="True" SortExpression="EmailAdmin" />
                                <asp:BoundField DataField="MatKhauAdmin" HeaderText="Password" SortExpression="MatKhauAdmin" />
                                <asp:BoundField DataField="RoleAdmin" HeaderText="Role" SortExpression="RoleAdmin" />
                            </Columns>
                        </asp:GridView>
                    </ContentTemplate>
                    <Triggers>
                            ...
                            <div class="modal-body">
                                <table class="table">
                                    <tr>
                                        <td>Email: (*)</td>
                                        <td>
                                            <asp:TextBox ID="txtEmailAdmin" runat="server" CssClass="form-control"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td>Password: (*)</td>
                                        <td>
                                            <asp:TextBox ID="txtMatKhauAdmin" runat="server" CssClass="form-control"></asp:TextBox>
                                        </td>
                                    </tr>
                            ...
                            <div class="modal-body">
                                <table class="table">
                                    <tr>
                                        <td>Email: (*)</td>
                                        <td>
                                            <asp:TextBox ID="txtEmailAdmin1" ReadOnly="true" runat="server" CssClass="form-control"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td>Password: (*)</td>
                                        <td>
                                            <asp:TextBox ID="txtMatKhauAdmin1" runat="server" CssClass="form-control"></asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Role: (*)</td>
                                        <td>
                                            <asp:DropDownList ID="ddlRoleAdmin1" runat="server">
                                                <asp:ListItem>Admin</asp:ListItem>
                                                <asp:ListItem>Member</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
        ...
        <div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                ...
                SelectCommand="SELECT * FROM [tbl00_Admin]"
                DeleteCommand="DELETE FROM [tbl00_Admin] WHERE [EmailAdmin] = @EmailAdmin"
                InsertCommand="INSERT INTO [tbl00_Admin] ([EmailAdmin], [MatKhauAdmin], [RoleAdmin]) VALUES (@EmailAdmin, @MatKhauAdmin, @RoleAdmin)"
                UpdateCommand="UPDATE [tbl00_Admin] SET [MatKhauAdmin] = @MatKhauAdmin, [RoleAdmin] = @RoleAdmin WHERE [EmailAdmin] = @EmailAdmin">
                <DeleteParameters>
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="RoleAdmin" Type="String" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="MatKhauAdmin" Type="String" />
                    <asp:Parameter Name="RoleAdmin" Type="String" />
