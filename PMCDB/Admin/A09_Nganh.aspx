<%@ Page Title="" Language="C#" MasterPageFile="~/Sa.Master" AutoEventWireup="true" CodeBehind="A09_Nganh.aspx.cs" Inherits="PMCDB.Admin.A09_Nganh" %>
    ...
    <asp:Panel ID="panelPhanQuyen" runat="server">
                ...
                <asp:UpdatePanel ID="upCrudGrid" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" HorizontalAlign="Center" OnRowCommand="GridView1_RowCommand"
                            ...
                            DataKeyNames="MaNganh" CssClass="table" DataSourceID="SqlDataSource1">
                            <Columns>
                                ...
                                <div class="modal-body">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>Tên Ngành: (*)</td>
                                            <td>
                                                <asp:TextBox ID="txtTenNganh1" runat="server" CssClass="form-control"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Mã Khoa: (*)</td>
        ...
        <div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PMCDBConnectionString %>" 
                DeleteCommand="DELETE FROM [tbl09_Nganh] WHERE [MaNganh] = @MaNganh" 
                InsertCommand="INSERT INTO [tbl09_Nganh] ([MaNganh], [TenNganh], [MaKhoa]) VALUES (@MaNganh, @TenNganh, @MaKhoa)" 
                SelectCommand="SELECT * FROM [tbl09_Nganh]" 
                UpdateCommand="UPDATE [tbl09_Nganh] SET [TenNganh] = @TenNganh, [MaKhoa] = @MaKhoa WHERE [MaNganh] = @MaNganh">
                <DeleteParameters>
