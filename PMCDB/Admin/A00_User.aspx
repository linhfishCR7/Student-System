<%@ Page Title="" Language="C#" MasterPageFile="~/Sa.Master" AutoEventWireup="true" CodeBehind="A00_User.aspx.cs" Inherits="PMCDB.Admin.A00_User" %>
    ...
    <asp:Panel ID="panelPhanQuyen" runat="server">
                ...
                <asp:UpdatePanel ID="upCrudGrid" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" HorizontalAlign="Center" OnRowCommand="GridView1_RowCommand"
                            ...
                            DataKeyNames="Email" CssClass="table" DataSourceID="SqlDataSource1">
                            <Columns>
                            ...
                            <div class="modal-body">
                                <table class="table">
                                    <tr>
                                        <td>Email: (*)</td>
                                        <td>
                                            <asp:TextBox ID="txtEmail1" ReadOnly="true" runat="server" CssClass="form-control"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td>Password: (*)</td>
                                        <td>
                                            <asp:TextBox ID="txtMatKhau1" runat="server" CssClass="form-control"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </div>
        ...
        <div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                ...
                SelectCommand="SELECT * FROM [tbl00_User]"
                DeleteCommand="DELETE FROM [tbl00_User] WHERE [Email] = @Email"
                InsertCommand="INSERT INTO [tbl00_User] ([Email], [MatKhau]) VALUES (@Email, @MatKhau)"
                UpdateCommand="UPDATE [tbl00_User] SET [MatKhau] = @MatKhau WHERE [Email] = @Email">
                <DeleteParameters>
