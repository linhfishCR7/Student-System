...
{
    public partial class A02_KhoaHoc : System.Web.UI.Page
    {
        ...
        protected void btnAddRecord_Click(object sender, EventArgs e)
        {
            if (IsValid)
            {
                ...
                parameters["NamBatDau"].DefaultValue = txtNamBatDau.Text;
                parameters["NamKetThuc"].DefaultValue = txtNamKetThuc.Text;
                try
                {
                        ...
                        try
                        {
                                         ...
                                         new OleDbConnection(excelConnectionString))
                            {
                                ...
                                using (DbDataReader dr = command.ExecuteReader())
                                {
                                    ...
                                    {
                                        bulkCopy.DestinationTableName = "tbl06_LoaiDonGia";
                                        bulkCopy.WriteToServer(dr);
                                        panelError.Visible = true;
                                        lblError.Text = "The data has been exported succefully from Excel to SQL";
                                        GridView1.DataBind();
                                    }
                                }
                            }
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("editRecord"))
            {
                ...
                txtMaKhoaHoc1.Text = HttpUtility.HtmlDecode(gvrow.Cells[2].Text).ToString();
                txtNamBatDau1.Text = HttpUtility.HtmlDecode(gvrow.Cells[3].Text).ToString();
                txtNamKetThuc1.Text = HttpUtility.HtmlDecode(gvrow.Cells[4].Text).ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (IsValid)
            {
                ...
                parameters["NamBatDau"].DefaultValue = txtNamBatDau1.Text;
                parameters["NamKetThuc"].DefaultValue = txtNamKetThuc1.Text;
                try
                {
                    if (txtMaKhoaHoc1.Text == "")
                    {
                        ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Các trường (*) không được bỏ trống.');", true);
                    }
        ...
        private void executeDelete(string code)
        {
            if (IsValid)
            {
                ...
                parameters["MaKhoaHoc"].DefaultValue = code;
