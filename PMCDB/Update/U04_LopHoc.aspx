                ...
                <asp:UpdatePanel ID="upCrudGrid" runat="server">
                    <ContentTemplate>
                        <table class="table">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <a href="U00_PhanQuyenDuAn.aspx" class="btn btn-info"><span class="glyphicon glyphicon-refresh"></span> Quay Về</a>
                                    <a href="U04_LopHocSearch.aspx" class="btn btn-primary"><span class="glyphicon glyphicon-search"></span> Search</a>
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" HorizontalAlign="Center" OnRowCommand="GridView1_RowCommand"
                            ...
                            DataKeyNames="MaLop" CssClass="table" DataSourceID="SqlDataSource1" EmptyDataText="No SV FOUND!">
                            <Columns>
