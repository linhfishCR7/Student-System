...
{
    public partial class U04_LopHocSearch : System.Web.UI.Page
    {
        ...
        protected void ButSearch_Click(object sender, EventArgs e)
        {
            ...
            string sqlquery = "select * from [dbo].[tbl04_LopHoc] where MaLop like '%'+@MaLop+'%' or MaKhoaHoc like '%'+@MaKhoaHoc+'%' or MaCT like '%'+@MaCT+'%' or STT like @STT or MaNganh like '%'+@MaNganh+'%' ";
            sqlcomm.CommandText = sqlquery;
            sqlcomm.Connection = sqlconn;
            sqlcomm.Parameters.AddWithValue("MaLop", Txtsearch.Text);
            sqlcomm.Parameters.AddWithValue("MaKhoaHoc", Txtsearch.Text);
            sqlcomm.Parameters.AddWithValue("MaCT", Txtsearch.Text);
            sqlcomm.Parameters.AddWithValue("STT", Txtsearch.Text);
            sqlcomm.Parameters.AddWithValue("MaNganh", Txtsearch.Text);
