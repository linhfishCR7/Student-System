                    ...
                    <ContentTemplate>
                           ...
                           <%-- <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <a href="U05_SinhVienSearch.aspx" class="btn btn-primary"><span class="glyphicon glyphicon-search"></span> Search</a>
                                </td>
                               <%-- <td>
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" HorizontalAlign="Center" OnRowCommand="GridView1_RowCommand"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="HoTen" HeaderText="Học Và Tên" SortExpression="HoTen" />
                        ...
                        <asp:UpdatePanel ID="upAdd" runat="server">
                            <ContentTemplate>
                                <div class="modal-body">
                                    <%-- (([MaSV], [HoTen], [NgaySinh], [DanToc], [MaLop]))--%>
                                    <table class="table">
                                        <tr>
                                            <td>Mã Sinh Viên: (*)</td>
                                            <td>
