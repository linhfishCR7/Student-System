...
{
    public partial class U02_KhoaHoc : System.Web.UI.Page
    {
        ...
        protected void btnAddRecord_Click(object sender, EventArgs e)
        {
            if (IsValid)
            {
                ...
                try
                {
                    ...
                    else if (txtNamBatDau.Text == "")
                    {
                        ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Các trường (*) không được bỏ trống.');", true);
                    }
                    else if (txtNamKetThuc.Text == "")
                    {
                        ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Các trường (*) không được bỏ trống.');", true);
                    }
                    else
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (IsValid)
            {
                ...
                try
                {
                    ...
                    else if (txtNamBatDau1.Text == "")
                    {
                        ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Các trường (*) không được bỏ trống.');", true);
                    }
                    else if (txtNamKetThuc1.Text == "")
                    {
                        ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Các trường (*) không được bỏ trống.');", true);
                    }
                    else
