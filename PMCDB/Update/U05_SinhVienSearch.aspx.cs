...
{
    public partial class U05_SinhVienSearch : System.Web.UI.Page
    {
        ...
        protected void ButSearch_Click(object sender, EventArgs e)
        {
            ...
            string sqlquery = "select * from [dbo].[tbl05_SinhVien] where HoTen like '%'+@HoTen+'%' or MaSV like @MaSV or NgaySinh like @NgaySinh or DanToc like '%'+@DanToc+'%' or MaLop like '%'+@MaLop+'%' ";
            sqlcomm.CommandText = sqlquery;
            sqlcomm.Connection = sqlconn;
            sqlcomm.Parameters.AddWithValue("HoTen" , Txtsearch.Text);
            sqlcomm.Parameters.AddWithValue("MaSV", Txtsearch.Text);
            sqlcomm.Parameters.AddWithValue("NgaySinh", Txtsearch.Text);
            sqlcomm.Parameters.AddWithValue("DanToc", Txtsearch.Text);
