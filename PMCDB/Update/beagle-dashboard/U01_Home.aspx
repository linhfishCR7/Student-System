<%@ Page Title="" Language="C#" MasterPageFile="~/NewMain.Master" AutoEventWireup="true" CodeBehind="U01_Home.aspx.cs" Inherits="PMCDB.Update.beagle_dashboard.U01_Home" %>
                ...
                <div class="be-right-navbar">
                    <ul class="nav navbar-nav float-right be-user-nav">
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-expanded="false">
                            <img src="../../Themes/beagle-dashboard/assets/img\avatar.png" alt="Avatar"><span class="user-name">Túpac Amaru</span></a>
                            <div class="dropdown-menu" role="menu">
                                <div class="user-info">
                                    <div class="user-name">Túpac Amaru</div>
                                    <div class="user-position online">Available</div>
                                </div>
                                <a class="dropdown-item" href="pages-profile.html"><span class="icon mdi mdi-face"></span>Account</a><a class="dropdown-item" href="#"><span class="icon mdi mdi-settings"></span>Settings</a><a class="dropdown-item" href="pages-login.html"><span class="icon mdi mdi-power"></span>Logout</a>
                            </div>
                        </li>
                    </ul>
                                            ...
                                            <div class="content">
                                                <ul>
                                                    <li class="notification notification-unread"><a href="#">
                                                        <div class="image">
                                                            <img src="../../Themes/beagle-dashboard/assets/img\avatar2.png" alt="Avatar"></div>
                                                    ...
                                                    <li class="notification"><a href="#">
                                                        <div class="image">
                                                            <img src="../../Themes/beagle-dashboard/assets/img\avatar3.png" alt="Avatar"></div>
                                                        <div class="notification-info">
                                                    ...
                                                    <li class="notification"><a href="#">
                                                        <div class="image">
                                                            <img src="../../Themes/beagle-dashboard/assets/img\avatar4.png" alt="Avatar"></div>
                                                        <div class="notification-info">
                                                    ...
                                                    <li class="notification"><a href="#">
                                                        <div class="image">
                                                            <img src="../../Themes/beagle-dashboard/assets/img\avatar5.png" alt="Avatar"></div>
                            ...
                            <ul class="dropdown-menu be-connections">
                                <li>
                                    <div class="list">
                                        <div class="content">
                                            <div class="row">
                                                <div class="col"><a class="connection-item" href="#">
                                                    <img src="../../Themes/beagle-dashboard/assets/img\github.png" alt="Github"><span>GitHub</span></a></div>
                                                <div class="col"><a class="connection-item" href="#">
                                                    <img src="../../Themes/beagle-dashboard/assets/img\bitbucket.png" alt="Bitbucket"><span>Bitbucket</span></a></div>
                                                <div class="col"><a class="connection-item" href="#">
                                                    <img src="../../Themes/beagle-dashboard/assets/img\slack.png" alt="Slack"><span>Slack</span></a></div>
                                            </div>
                                            <div class="row">
                                                <div class="col"><a class="connection-item" href="#">
                                                    <img src="../../Themes/beagle-dashboard/assets/img\dribbble.png" alt="Dribbble"><span>Dribbble</span></a></div>
                                                <div class="col"><a class="connection-item" href="#">
                                                    <img src="../../Themes/beagle-dashboard/assets/img\mail_chimp.png" alt="Mail Chimp"><span>Mail Chimp</span></a></div>
                                                <div class="col"><a class="connection-item" href="#">
                                                    <img src="../../Themes/beagle-dashboard/assets/img\dropbox.png" alt="Dropbox"><span>Dropbox</span></a></div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-12 col-lg-6 col-xl-3">
                        <div class="widget widget-tile">
                            ...
                            <div class="data-info">
                                ...
                                <div class="value">
                                    <span class="indicator indicator-equal mdi mdi-chevron-right"></span><span class="number" data-toggle="counter" data-end="113">0</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-6 col-xl-3">
                        <div class="widget widget-tile">
                            ...
                            <div class="data-info">
                                ...
                                <div class="value">
                                    <span class="indicator indicator-positive mdi mdi-chevron-up"></span><span class="number" data-toggle="counter" data-end="532">0</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 col-xl-3">
                        <div class="widget widget-tile">
                            ...
                            <div class="data-info">
                                ...
                                <div class="value">
                                    <span class="indicator indicator-negative mdi mdi-chevron-down"></span><span class="number" data-toggle="counter" data-end="113">0</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="widget widget-fullwidth be-loading">
                            <div class="widget-head">
                                <div class="tools">
                                    <div class="dropdown">
                                        <a class="dropdown-toggle" data-toggle="dropdown"><span class="icon mdi mdi-more-vert d-inline-block d-md-none"></span></a>
                                        <div class="dropdown-menu" role="menu">
                                            <a class="dropdown-item" href="#">Week</a><a class="dropdown-item" href="#">Month</a><a class="dropdown-item" href="#">Year</a>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="user-avatar">
                                                <img src="../../Themes/beagle-dashboard/assets/img\avatar6.png" alt="Avatar">Penelope Thornton</td>
                                        ...
                                        <tr>
                                            <td class="user-avatar">
                                                <img src="../../Themes/beagle-dashboard/assets/img\avatar4.png" alt="Avatar">Benji Harper</td>
                                        ...
                                        <tr>
                                            <td class="user-avatar">
                                                <img src="../../Themes/beagle-dashboard/assets/img\avatar5.png" alt="Avatar">Justine Myranda</td>
                                        ...
                                        <tr>
                                            <td class="user-avatar">
                                                <img src="../../Themes/beagle-dashboard/assets/img\avatar3.png" alt="Avatar">Sherwood Clifford</td>
                                    ...
                                    <div class="be-scroller-chat">
                                        <div class="content">
                                            ...
                                            <div class="contact-list contact-list-recent">
                                                <div class="user">
                                                    <a href="#">
                                                        <img src="../../Themes/beagle-dashboard/assets/img\avatar1.png" alt="Avatar">
                                                ...
                                                <div class="user">
                                                    <a href="#">
                                                        <img src="../../Themes/beagle-dashboard/assets/img\avatar2.png" alt="Avatar">
                                                ...
                                                <div class="user">
                                                    <a href="#">
                                                        <img src="../../Themes/beagle-dashboard/assets/img\avatar3.png" alt="Avatar">
                                            ...
                                            <div class="contact-list">
                                                <div class="user">
                                                    <a href="#">
                                                        <img src="../../Themes/beagle-dashboard/assets/img\avatar4.png" alt="Avatar">
                                                        <div class="user-data2"><span class="status"></span><span class="name">Mike Bolthort</span></div>
                                                    </a>
                                                </div>
                                                <div class="user">
                                                    <a href="#">
                                                        <img src="../../Themes/beagle-dashboard/assets/img\avatar5.png" alt="Avatar">
                                                        <div class="user-data2"><span class="status"></span><span class="name">Maggie jackson</span></div>
                                                    </a>
                                                </div>
                                                <div class="user">
                                                    <a href="#">
                                                        <img src="../../Themes/beagle-dashboard/assets/img\avatar6.png" alt="Avatar">
