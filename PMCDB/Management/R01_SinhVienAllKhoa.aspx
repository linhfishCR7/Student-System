<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="R01_SinhVienAllKhoa.aspx.cs" Inherits="PMCDB.Management.R01_SinhVienAllKhoa" %>
        ...
        <div class="list-group">
            ...
            <div class="list-group-item">
                <table class="table">
                    ...
                    <tr>
                        <td>Mã Khoa:</td>
                        <td>
                            <asp:DropDownList ID="ddlMaKhoa" runat="server" DataSourceID="SqlDataSource1" DataTextField="TenKhoa" DataValueField="MaKhoa"></asp:DropDownList>
                        </td>
                    </tr>
            ...
            <div>
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataBySinhVien" TypeName="PMCDB.DataSet.dsSinhVienTableAdapters.V01_SinhVienTableAdapter" UpdateMethod="FillBySinhVien">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="ddlMaKhoa" Name="MaKhoa" PropertyName="Text" Type="String" />
                    </SelectParameters>
                    <UpdateParameters>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PMCDBConnectionString %>" SelectCommand="SELECT * FROM [tbl01_Khoa]"></asp:SqlDataSource>
            </div>
        </div>
    </asp:Panel>
